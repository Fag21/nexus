      ...
      >
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              >
                {[
                  ...
                  "Control social media screen time",
                  "Journal with AI reflection",
                  "Get a personal AI growth coach",
                ].map((item) => (
                  <div
                    key={item}
                    style={{
        ...
        {mode === "email" && (
          <>
            ...
            >
              Enter your email and we&apos;ll send you a magic link to activate
